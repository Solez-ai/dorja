    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.visitCard}>
        ...
        <View style={styles.visitDetailRow}>
          ...
          <Text style={styles.visitDetail}>Mirpur 11 · exact address unlocks in 43 min</Text>
        </View>
      ...
      {[
        ...
        <View key={i} style={styles.pastCard}>
          <View style={styles.pastRow}>
            ...
            <Badge text={v.status} bgColor={v.status === 'Completed' ? '#D7F1EE' : '#FCE8BE'} textColor={v.status === 'Completed' ? '#006B68' : '#C2710B'} />
          </View>
          <View style={styles.pastRow}>
...
const styles = StyleSheet.create({
  ...
  visitCard: { margin: 16, padding: 16, backgroundColor: 'white', borderRadius: 10, borderWidth: 1, borderColor: '#D9CCB9' },
  ...
  passButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#007C78', padding: 14, borderRadius: 2 },
  ...
  pastCard: { marginHorizontal: 16, padding: 12, backgroundColor: 'white', borderRadius: 4, borderWidth: 1, borderColor: '#E8E0D0', marginBottom: 8, gap: 6 },
