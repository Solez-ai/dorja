...
data class DorjaStrings(
    ...
    companion object {
        val ENGLISH: Map<String, String> = mapOf(
            ...
            "account_switch_subtitle" to "Switch to %1\$s to chat & explore as the other party. Each account keeps its own country, currency and documents.",
            ...
            "account_erase_body" to "This erases EVERYTHING stored about you on this device: all content, your profile and the accounts registered here. The app returns to a clean, empty state. This cannot be undone.",
            ...
            "account_erased_body" to "All personal data stored on this device has been erased. The app has been reset to a clean, empty state.",
            ...
            "account_erase_data_sub" to "Erases everything above plus your profile rows, then resets the app to a clean, empty state.",
            ...
            "assistant_subtitle" to "On-device · private",
            "assistant_ready" to "READY",
            "assistant_failed" to "TAP TO RETRY",
            "assistant_downloading" to "SETTING UP…",
            "assistant_welcome" to "I can search listings, compare options and answer questions about how DORJA works — all on your device.",
            "assistant_input_hint" to "Ask about properties…",
            "assistant_unmatched" to "I couldn't map that to something I can do. Try asking about listings, visits, scans or verification.",
            "assistant_error" to "The assistant model failed to load. Tap the status pill to retry.",
            "common_send" to "Send",
            // ── Inbox extras ──
